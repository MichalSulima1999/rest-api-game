...
@Service
@Validated
public class ItemServiceImplementation extends AbstractItemService {

    public ItemServiceImplementation(ItemRepository itemRepository, CharacterRepository characterRepository, IAuthenticationFacade authenticationFacade, ItemMapper itemMapper, StatisticsMapper statisticsMapper) {
        super(itemRepository, characterRepository, authenticationFacade, itemMapper, statisticsMapper);
    }
